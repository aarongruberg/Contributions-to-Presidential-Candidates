...
> There wasn't a strong relationship between contributionn amount and the file number of the form completed by contributors.
...
> This is a boxplot of contribution amount vs. county.
...
```{r echo=FALSE, message=FALSE, warning=FALSE, scatter_amount_vs_industry_wrapped_candidate}
...
> Scatter plot of contribution amount vs. date, colored by industry and facet wrapped by candidate name.
...
> I didn't expect contributors to Bernie Sanders and Donald Trump be from the same industry categories.  There were many blue collar and unemployed contributors to both campaigns.  The list blue collar occupations I created mixed traditional blue collar jobs such as contruction or plumbing with modern jobs such as cashier or customer service.  I was surprised that so many contributors labeled themselves as unemployed.  There may have been contributors who were unemployed but excited about a their candidate, people who did not wish to disclose their employment, or white collar professionals between jobs.  
