...
I looked at the total contributions per date for each county.  I only included 
contributions to Hillary Clinton and Donald Trump.  I applied a log scale to 
the y axis and a cube root scale on the x axis.  The correlation between the 
numeric date value and the total contribution per county was 0.351.
------
